...
from thermalright_lcd_control.device_controller.metrics.memory_metrics import MemoryMetrics
...
class FrameManager:
    ...
    def __init__(self, config: DisplayConfig):
        ...
        if len(config.metrics_configs) != 0:
            ...
            self.ram_metrics = MemoryMetrics()
    ...
    def _get_current_metric(self):
        try:
            ...
            ram_data = self.ram_metrics.get_all_metrics()
            ...
            return {
                ...
                # System metrics
                'ram_usage': ram_data.get('usage_percentage')
            }
        except Exception as e:
