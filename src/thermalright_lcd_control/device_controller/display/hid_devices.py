...
class DisplayDevice04168001(HidDevice):
    """
    Thermalright 480x480 HID display that enumerates as 0416:8001.
    """
    W, H = 480, 480
    ...
    def info() -> dict:
        return {
            "class_name": f"{DisplayDevice04168001.__module__}.{DisplayDevice04168001.__name__}",
            "width": DisplayDevice04168001.W,
            "height": DisplayDevice04168001.H,
            "vid": DisplayDevice04168001.VID,
            "pid": DisplayDevice04168001.PID,
        }
